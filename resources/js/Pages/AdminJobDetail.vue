            ...
            <div class="flex">
                ...
                <div class="w-1/2 pr-4">
                    <div class="mb-4">
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <span :class="`px-2 py-1 rounded-full text-sm ${getStatusColor(jobs?.status)}`">
                    ...
                    <div class="mb-4">
                        <label class="block mb-2 font-bold">Job Description</label>
                        <div class="p-2 bg-gray-50 rounded min-h-[8rem] whitespace-pre-wrap">
                            {{ jobs?.description || 'No description available' }}
                        </div>
                    </div>
                    <div class="text-sm text-gray-500">
                        <div>Created: {{ dayjs(jobs?.created_at).format('DD MMMM YYYY HH:mm') }}</div>
                        <div>Last Updated: {{ dayjs(jobs?.updated_at).format('DD MMMM YYYY HH:mm') }}</div>
                    </div>
                </div>
                ...
                <div class="w-1/2 pl-4">
                    ...
                    <div class="mb-8">
                        ...
                        <div v-if="jobs?.salary_ranges?.length" class="space-y-2">
                            <div v-for="range in jobs.salary_ranges" 
                                 :key="range.id"
