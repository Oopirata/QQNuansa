    ...
    <div class="w-3/4 p-8">
      ...
      <div class="flex">
        ...
        <div class="w-1/2 pr-4">
          ...
          <div v-for="email in emails.sent" 
               :key="email.id" 
               class="bg-white p-4 rounded shadow mb-4 last:mb-0">
            <div class="flex items-center mb-2">
              <img :src="email.avatar" alt="User Avatar" class="mr-2 rounded-full" />
              <div>
                <p class="font-semibold">{{ email.name }}</p>
                <p class="text-sm text-gray-500">{{ email.subject }}</p>
              </div>
              <span class="ml-auto text-sm text-gray-500">{{ email.time }}</span>
            </div>
        ...
        <div class="w-1/2 pl-4">
          ...
          <div v-for="email in emails.inbox" 
               :key="email.id" 
               class="bg-white p-4 rounded shadow mb-4 last:mb-0">
            <div class="flex items-center mb-2">
              <img :src="email.avatar" alt="User Avatar" class="mr-2 rounded-full" />
